...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      styleSrc: ["'self'", "'unsafe-inline'", "https://cdn-uicons.flaticon.com", "https://fonts.googleapis.com"],
      imgSrc: ["'self'", "data:", "https:", "blob:", "https://maps.gstatic.com", "https://*.googleapis.com"],
      fontSrc: ["'self'", "https://cdn-uicons.flaticon.com", "https://fonts.gstatic.com"],
      mediaSrc: ["'self'", "data:", "https:", "blob:"],
      frameSrc: ["'self'", "blob:", "https://www.openstreetmap.org", "https://www.google.com", "https://*.google.com"],
      objectSrc: ["'none'"],
    },
  },
